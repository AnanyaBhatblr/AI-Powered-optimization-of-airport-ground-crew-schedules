...
# Specify file paths
input_csv = "../dataset/BT1/output_with_crew_demandBT1.csv"  # Replace with your input CSV file path
output_csv = "../dataset/BT1/output_with_datesBT1.csv"  # Output file path
