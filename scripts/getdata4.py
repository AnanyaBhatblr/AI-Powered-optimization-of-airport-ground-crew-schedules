...
# Specify file paths
input_csv = "../dataset/BT1/task_personnel_summaryBT1.csv"  # Replace with your input CSV file path
output_csv = "../dataset/BT1/output_with_crew_demandBT1.csv"  # Output file path
