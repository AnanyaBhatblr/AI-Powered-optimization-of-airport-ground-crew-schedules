MUMBAI_AIRPORT_LOCATIONS = {
    # Terminals
    'Terminal 1': (0, 0),
    'Terminal 2': (800, 0),  # Integrated terminal
    ...
    # Runways and Taxiways - Adding missing runways with correct names
    'Runway 09R-27L': (1000, -1200),  # South Runway
    'Runway 09L-27R': (1000, 1200),   # North Runway
    'Taxiway A': (1000, -600),
    'Taxiway B': (1000, 600),
    'Taxiway C': (0, 0),
